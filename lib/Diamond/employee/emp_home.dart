...
class _EmpHomeState extends State<EmpHome> {
  ...
  final Stream<DocumentSnapshot> future = FirebaseFirestore.instance
      .collection('Employee')
      .doc(FirebaseAuth.instance.currentUser?.uid)
      .collection('EmpData')
      .doc(DateFormat('d-MM-yyyy').format(DateTime.now()))
      .snapshots();
                ...
                StreamBuilder<DocumentSnapshot>(
                    ...
                    builder: (BuildContext context,
                      ...
                      if (snapshot.hasData && snapshot.data!.exists) {
                        DocumentSnapshot? docsd = snapshot.data;
                        data = docsd?.data() as Map<String, dynamic>;
                        // data=snapshot.data?.data() as Map<String,dynamic> ;
                        finalDisplayFinalList.clear();
                        finalDisplayFinalList.add(data);
